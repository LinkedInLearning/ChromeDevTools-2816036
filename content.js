...
function dragEnd(e) {
  ...
  sendMessage({subject: "saveMessage", resp: {card: { cardId },comment:{commentId, posX, posY, commentText, text }}})
  removeTag(commentId);
}
...
function saveComment (msg, e) {
  ...
  sendMessage({subject: "saveMessage", resp: {card: msg.resp.card, comment:{ commentId: msg.resp.comment.commentId, posX, posY, commentText: commentInput.value, text}}})
}
